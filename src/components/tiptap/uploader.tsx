...
const FileUploader = (
  { editor, disable }: { editor: Editor, disable?: boolean }) => {
  const addImage = (e) => {
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Button
            ...
            variant={null}
            disabled={disable}
            className=' relative hover:bg-blue-50  rounded-lg h-[6vh] justify-center flex items-center text-[12px] gap-x-4 cursor-pointer'>
            <Input
              type='file'
        ...
        <TooltipContent side='left'>
          <p className=' text-[12px]'>Image from folder</p>
        </TooltipContent>
      </Tooltip>
    </TooltipProvider>
  )
